Arrays have a central role in programming. __C3__ offers built-in arrays, slices and _vectors_. The standard library enhances this further with dynamically sized arrays and other collections.
